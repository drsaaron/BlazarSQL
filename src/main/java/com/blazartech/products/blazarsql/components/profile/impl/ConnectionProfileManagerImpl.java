...
/**
 * base class for an implementation of the connection profile that persists the data;
 * derived classes will implement the persisting functionality.
 * 
 * @author aar1069
 * @version $Id: ConnectionProfileManagerImpl.java 30 2015-04-23 19:52:54Z aar1069 $
 */
...
public abstract class ConnectionProfileManagerImpl implements ConnectionProfileManager {
    ...
    public ConnectionProfile getDefaultProfile() {
        for (ConnectionProfile p : getProfiles()) {
